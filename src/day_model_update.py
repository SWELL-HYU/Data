...
if __name__ == "__main__":
    ...
    updater = DayModelUpdater(
        night_model_path="Data/saved_models/neumf_night_model.pth",
        night_user_embedding_path="Data/warm_start/night_user_embedding.json",
        outfit_embeddings_csv="Data/warm_start/outfit_embeddings.csv",
        day_user_embedding_path="Data/warm_start/day_user_embedding.json"
    )
    ...
    new_positive_interactions = updater.load_interactions_from_csv(
        "Data/warm_start/user_outfit_interaction.csv"
    )
